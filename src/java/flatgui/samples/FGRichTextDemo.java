 ...
 */
public class FGRichTextDemo
{
    public static final String CONTAINER_NS = "flatgui.samples.forms.richtext";
    ...
    public static final String TITLE = "FlatGUI Demo - Rich Text";
