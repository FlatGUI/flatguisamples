 ...
 */
public class FGTable2DemoServer
{
    ...
    {
        InputStream compoundSampleIs = FGTable2DemoServer.class.getClassLoader().getResourceAsStream("flatgui/samples/forms/table2.clj");
