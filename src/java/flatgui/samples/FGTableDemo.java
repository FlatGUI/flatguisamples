    ...
    public static void main(String[] args) throws Exception
    {
        EventQueue.invokeLater(() -> {
            try
            {
                ...
                Frame frame = new Frame("FlatGUI Demo - :visible");
                ...
                InputStream is = FGCompoundDemoServer.class.getClassLoader().getResourceAsStream("flatgui/samples/forms/table.clj");
